...
export function EditTourism() {
  ...
  //POST METHOD
  const UpdateTourism = async (e) => {
    let fixDate = name.toISOString();
    e.preventDefault();
    ...
    try {
      ...
      navigate("/dashboard/tourism");
      alert("Data Prakiraan Cuaca Tourism Berhasil Di Update")
    } catch (error) {
      console.log(error);
    }
  };
          ...
          <form onSubmit={UpdateTourism}>
            ...
            <div className="mr-6 flex-auto bg-[#ffffffe5] pt-10 lg:px-6">
              <div className="flex justify-end gap-4 text-center">
                <Button>
                  <Link to={`/dashboard/tourism`}>Cancel</Link>
                </Button>
                <Button
                  type="submit"
